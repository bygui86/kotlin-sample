...
DEBUG_PORT := 5005
# # docker
DOCKER_IMAGE_NAME := samples/$(NAME)
...
# # jvm
MEM_OPTS := -Xms256m -Xmx256m -XX:MaxMetaspaceSize=300m
...
OTHER_OPTS := -Dspring.profiles.active=insecure,local
# # makefile
.PHONY: help
.DEFAULT_GOAL := help
...
deploy :		## Build the application package including all tests, push to artifact repo and deploy
	$(BUILD_TOOL) deploy
